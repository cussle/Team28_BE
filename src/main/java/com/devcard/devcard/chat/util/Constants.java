package com.devcard.devcard.chat.util;
...
public class Constants {
    ...
    // 오류 상수
    public static final String NO_QUERY_PARAMETER = " 쿼리 파라미터가 없습니다.";
    public static final String NUMBER_FORMAT_ERROR = " 추출 중 숫자 형식 오류가 발생했습니다.";
}
