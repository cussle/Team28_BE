...
public class QnAService {
    ...
    public QnAResponse getQnA(Long id) {
        ...
        return new QnAResponse(qna.getName(), qna.getQuestionTitle(), qna.getQuestionContent(), qna.getAnswer(), qna.getQuestionTimestamp(), qna.getAnswerTimestamp(), qna.isAnswerCompleted());
    }
